...
<div id="aboutme" className="section-div aboutme-div" style={{paddingTop:"100px"}}>
    <Container className="profile-container">
      ...
      <Row style={{ marginTop: "25px" }}>
          ...
          <h2>Hi, I'm Casey! 👋</h2>
          <p>I'm a full-stack developer with a background in international relations and program coordination. Originally from Indiana (go Hoosiers!), my passion for language learning and exploration led me to live & study in Chile, Turkey, and Azerbaijan. I'm now learning new programming languages in the great city of Philadelphia.</p>
